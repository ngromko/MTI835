 ...
 *
 * - CIS_CONSTRAINED_DELAUNAY will insert the whole edge. Thereby
 * triangles may lose their empty circle property.
 * - CIS_CONFORMING_DELAUNAY will subdivide the edge if necessary
 * to maintain the empty circle property.
 *
 ...
 * are now deprecated. For backward compatibility they are kept.
 */
