...
*
* @note This method will not use the z-coordinate (if any)
*/
inline
double sqDistance2D(const Point2& p0,const Point2& p1)
{
	...
	double result(deltaX*deltaX+deltaY*deltaY);
...
*
* @note In contrast to sqDistance2D this method will use the z-coordinate of the points
*/
inline
...
*
* @note: The true midpoint of p0 and p1 may not exist in floating point
* numbers. The returned point may not be collinear with p0 and p1.
*/
